...
export const sampleEquipment = [
  ...
  {
    id: 'boss_summon_scroll_laziness',
    name: 'Свиток призыва Лени',
    type: 'consumable',
    subType: 'boss_summon',
    bossId: 'laziness',
    description: 'Призывает босса Лень для борьбы с ним.',
    rarity: 'common',
    price: 1,
    imageUrl: null,
    usable: true
  ...
  {
    id: 'boss_summon_scroll_chaos',
    name: 'Свиток призыва Хаоса',
    type: 'consumable',
    subType: 'boss_summon',
    bossId: 'chaos',
    description: 'Призывает босса Хаос для борьбы с ним.',
    rarity: 'uncommon',
    price: 1,
    imageUrl: null,
    usable: true
  ...
  {
    id: 'boss_summon_scroll_distraction',
    name: 'Свиток призыва Отвлечения',
    type: 'consumable',
    subType: 'boss_summon',
    bossId: 'distraction',
    description: 'Призывает босса Отвлечение для испытания вашей концентрации.',
    rarity: 'rare',
    price: 1,
    imageUrl: null,
    usable: true
  ...
  {
    id: 'boss_summon_scroll_time_eater',
    name: 'Свиток призыва Пожирателя Времени',
    type: 'consumable',
    subType: 'boss_summon',
    bossId: 'time_eater',
    description: 'Призывает эпического босса Пожирателя Времени.',
    rarity: 'epic',
    price: 1,
    imageUrl: null,
    usable: true
  ...
  {
    id: 'boss_summon_scroll_burnout',
    name: 'Свиток призыва Выгорания',
    type: 'consumable',
    subType: 'boss_summon',
    bossId: 'burnout',
    description: 'Призывает эпического босса Выгорание для борьбы с ним.',
    rarity: 'epic',
    price: 1,
    imageUrl: null,
    usable: true
  ...
  {
    id: 'boss_summon_scroll_procrastination_lord',
    name: 'Свиток призыва Повелителя Прокрастинации',
    type: 'consumable',
    subType: 'boss_summon',
    bossId: 'procrastination_lord',
    description: 'Призывает легендарного босса Повелителя Прокрастинации.',
    rarity: 'legendary',
    price: 1,
    imageUrl: null,
    usable: true
